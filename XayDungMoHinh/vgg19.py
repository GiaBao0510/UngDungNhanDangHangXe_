...
model.add(Convolution2D(256, (3,3), ativation='relu', padding='same', kernel_initializer='he_uniform', name='block3_conv4'))
...
model.add(Convolution2D(512, (3,3), ativation='relu', padding='same', kernel_initializer='he_uniform', name='block4_conv4'))
